 ...
 * through the convenience method {@link DataStreamUtils#getStatistics(WindowedDataStream)}.
 *
 * @param <OUT>
...
public class WindowedDataStreamStatistics<OUT> extends WindowedDataStream<OUT> {
	...
	public DiscretizedStream<OUT> median(int pos) {
		...
		// Median can be regarded as a special mapWindow
		return discretize(WindowUtils.WindowTransformation.MAPWINDOW, windowBuffer);
	}
